...
const Constant = () => {
  ...
  return (
    <div className="flex items-center justify-between bg-white shadow p-4 rounded-lg w-full max-w-full px-10">
      ...
      <div className="hidden sm:flex items-center border border-gray-300 rounded-full px-2 py-2 w-full max-w-md">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
      ...
      {/* Right-side Icons (Messages, Avatar, Arrow) - Hidden on mobile */}
      <div className="flex items-center space-x-4 ml-6 hidden sm:flex">
        <button className="relative">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
